...
public class StringUtil {
    ...
    public static String getFirstUpperPinyin(String str) {
        ...
        String pinyin = StringUtil.getFormatPinyin(str);
        String oldFirstChar = pinyin.substring(0, 1);
        String newFirstChar = oldFirstChar.toUpperCase(Locale.getDefault());
        return newFirstChar;
    }
}
